<script lang="ts">
  ...
  export let title: string = ""; // Optional card title
  export let subtitle: string = ""; // Optional card subtitle
  export let padding: string = "p-6"; // Customizable padding
...
<div class={cardClasses} onclick={handleClick}>
  {#if title}
    <div class="mb-1">
